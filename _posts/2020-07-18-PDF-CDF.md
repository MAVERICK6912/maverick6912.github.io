...
Since we already have a PDF plot all that we need to do now is find the area under the curve <10,000. This can be done easily by finding the integral of the PDF.
