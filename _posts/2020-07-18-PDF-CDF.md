...
Lets say PDF of our _ApplicantIncome_ distribution(X) is:
...
- The third property states that the area between the function and the x-axis must be 1, or that all probabilities must integrate to 1. This is again makes sense as the probability of an event to occur cannot be <1.
